 ...
 * Part 6: Creating Motion and Animation
 *
 * File: Project_Liberty_Light_Part_6.ino
 * Written by: Dustin Hodges (Motbots)
 * Date Created: 06/14/2026
 * Date Last Modified: 06/16/2026
 * Description: This is Part 6 of Project Liberty Light, a multi-part build where
 ...
 *
 * Article URL: https://motbots.com/project-liberty-light-part-6/
 *
...
void setup() {
  ...
  delay(1000);
  Serial.println("PART 6 SKETCH STARTED");
