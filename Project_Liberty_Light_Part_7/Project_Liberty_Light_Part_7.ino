 ...
 * Part 7: Creating Motion and Animation
 *
 * File: Project_Liberty_Light_Part_7.ino
 * Written by: Dustin Hodges (Motbots)
 * Date Created: 06/16/2026
 * Date Last Modified: 06/22/2026
 * Description: This is Part 7 of Project Liberty Light, a multi-part build where
 ...
 *
 * Article URL: https://motbots.com/project-liberty-light-part-7/
 *
...
const int celebrationButtonPin = 3; // Former Color Button
...
enum DisplayMode {
  MODE_STATIC_FLAG,             // previous name was MODE_FLAG
  MODE_WAVING_FLAG,
  MODE_TWINKLE_FLAG,
...
bool lastCelebrationButtonState = HIGH; // updated from lastColorButtonState
...
void setup() {
  ...
  pinMode(celebrationButtonPin, INPUT_PULLUP);    // updated from colorButtonPin
